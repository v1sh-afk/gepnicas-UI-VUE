...
export default {
    ...
    methods: {
        ...
        getImages() {
            axios.get('http://192.168.0.112:5000/getImages')
                .then(response => {
        ...
        getDashboard() {
            axios.get('http://192.168.0.112:5000/getInstanceCount')
                .then(response => {
        ...
        buttonClick(iname) {
            ...
            axios.get(`http://192.168.0.112:5000/getInstanceCount?instancename=${iname}`)
                .then(response => {
        ...
        Totalfile(iname){
                this.showPage=true
                axios.get(`http://192.168.0.112:5000/getBidsTenderInstance?instancename=${iname}`)
                    .then(response => {
        ...
        TotalMain(reqq){
            ...
            this.currentPage = 1
            axios.get(`http://192.168.0.112:5000/${reqq}`)
            .then(response => {
                this.bidstenders.bids = response.data.bids; 
                this.bidstenders.tenders = response.data.tenders; 
            })
        ...
        Archived(iname){
                this.showPage=true
                axios.get(`http://192.168.0.112:5000/getBidsTenderInstanceArchived?instancename=${iname}`)
                    .then(response => {
                        this.bidstenders.bids = response.data.bids; 
                        this.bidstenders.tenders = response.data.tenders;  
                    })
        ...
        Metalink(iname){
            axios.get(`http://192.168.0.112:5000/getBidsTenderInstanceMetalink?instancename=${iname}`)
                .then(response => {
                    this.bidstenders.bids = response.data.bids; 
                    this.bidstenders.tenders = response.data.tenders;
                })
        ...
        Errorr(iname){
            axios.get(`http://192.168.0.112:5000/getBidsTenderInstanceError?instancename=${iname}`)
                .then(response => {
                    this.bidstenders.bids = response.data.bids; 
                    this.bidstenders.tenders = response.data.tenders; 
                })
